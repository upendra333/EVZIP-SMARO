...
export function CreateAirportBookingModal({
  isOpen,
  onClose,
}: CreateAirportBookingModalProps) {
  ...
  const createMutation = useCreateAirportBooking()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await createMutation.mutateAsync({
        ...
        drop: formData.drop,
        flight_no: formData.flight_no || undefined,
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setFormData((prev) => ({ ...prev, flight_no: e.target.value }))}
