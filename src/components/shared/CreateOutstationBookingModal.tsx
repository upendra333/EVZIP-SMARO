...
import { useCreateOutstationBooking } from '../../hooks/useCreateBooking'
...
interface CreateOutstationBookingModalProps {
  isOpen: boolean
  onClose: () => void
}

export function CreateOutstationBookingModal({
  isOpen,
  onClose,
}: CreateOutstationBookingModalProps) {
  ...
  const createMutation = useCreateOutstationBooking()
