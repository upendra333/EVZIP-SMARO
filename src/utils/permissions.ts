...
export const PERMISSIONS = {
  ...
  VIEW_RIDE_HAILING_REPORTS: 'view_ride_hailing_reports',
...
export const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
  ...
  supervisor: [
    ...
    PERMISSIONS.VIEW_RIDE_HAILING_REPORTS,
...
export const PERMISSION_LABELS: Record<Permission, string> = {
  ...
  [PERMISSIONS.VIEW_RIDE_HAILING_REPORTS]: 'View Ride Hailing Reports',
  ...
  [PERMISSIONS.VIEW_REPORTS]: 'View SMARO Reports',
  [PERMISSIONS.EXPORT_REPORTS]: 'Export SMARO Reports',
  [PERMISSIONS.VIEW_ANALYTICS]: 'View SMARO Analytics',
  ...
  [PERMISSIONS.CREATE_SUBSCRIPTION]: 'Create Subscription',
  [PERMISSIONS.EDIT_SUBSCRIPTION]: 'Edit Subscription',
  [PERMISSIONS.DELETE_SUBSCRIPTION]: 'Delete Subscription',
